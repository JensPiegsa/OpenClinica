...
sed -i "/^dbHost=.*/c\dbHost=db" /tomcat/webapps/OpenClinica/WEB-INF/classes/datainfo.properties
sed -i "/^dbPort=.*/c\dbPort=db" /tomcat/webapps/OpenClinica/WEB-INF/classes/datainfo.properties

sed -i "/^dbHost=.*/c\dbHost=$DB_PORT_5432_TCP_ADDR" /tomcat/webapps/OpenClinica-ws/WEB-INF/classes/datainfo.properties
